...
const traceDefaults = {
  ...
  randomEvents: {
    count: 0.1,
    exceptionCount: 0.2,
    randomAttributes: { count: 6, cardinality: 20 },
  },
};
...
const traceTemplates = [
  {
    ...
    spans: [
      ...
      { service: "shop-backend", name: "fetch-articles", parentIdx: 0 },
      {
        ...
        links: [
          {
            attributes: { "link-type": "parent-child" },
            randomAttributes: { count: 2, cardinality: 5 },
          },
        ],
      },
  ...
  },
  {
    defaults: {
      ...
      randomEvents: {
        count: 2,
        randomAttributes: { count: 3, cardinality: 10 },
      },
    },
    spans: [
      {
    ...
    spans: [
      ...
      },
      {
        ...
        randomEvents: {
          count: 0.5,
          exceptionCount: 2,
          randomAttributes: { count: 5, cardinality: 5 },
        },
      },
    ],
  },
